...
const TestMessage = () => {
  return (
    <div className="flex max-md:flex-col justify-between items-start 2xl:mx-64 xl:mx-40 max-xl:mx-5 my-10">
      <img
        sizes="(max-width: 992px) 100vw, 992px"
        width="992"
        height="992"
        data-src="http://dripify.io/wp-content/uploads/2025/02/ab-test.png"
        alt=""
        src="http://dripify.io/wp-content/uploads/2025/02/ab-test.png"
        className="w-[45%] max-md:w-[90%]"
      ></img>
      <div className="flex flex-col items-start justify-between">
        <span className=" text-xs font-thicboi-bold text-[#7760f9] bg-[#7760f91a] rounded-full py-2 px-3  ml-0 -mt-8 max-md:mt-5">
          COMING SOON
        </span>
        <p className="text-5xl font-thicboi-semibold my-10 text-start">
          A/B test your <br /> message{" "}
        </p>
        <p className="font-thicboi-medium text-base mb-10 text-start text-stone-500">
        ...
        <div className="grid grid-cols-2 gap-8 gap-y-12 mb-14">
          <div className="flex items-start justify-between">
            ...
            <p className="text-sm font-thicboi-medium ml-4">
              Test up to 4 versions of each <br /> message
            </p>
          </div>
          <div className="flex items-start justify-between">
            <svg
            ...
            <p className="text-sm font-thicboi-medium ml-2">
              Advance your variants with <br />
              different variables
            </p>
          </div>
          <div className="flex items-start justify-between ">
            ...
            <p className="text-sm font-thicboi-medium ml-4">
              Select your best variant or let <br />
